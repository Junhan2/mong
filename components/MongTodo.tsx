...
export default function MongTodo() {
  ...
  return (
    <motion.div
      ...
      initial={false}
      animate={{
        width: isExpanded ? "var(--mong-expanded-width)" : "var(--mong-collapsed-width)",
        height: isExpanded ? "auto" : "var(--mong-collapsed-height)",
        borderRadius: isExpanded ? "var(--mong-expanded-radius)" : "var(--mong-border-radius)",
      }}
      transition={{
        ...snappyTransition,
