  ...
  kakao: {
    ...
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24">
        <path 
          fill="#000000" 
          d="M12 3c-4.97 0-9 3.34-9 7.5 0 2.75 1.87 5.15 4.64 6.49L6.47 21.25c-.08.3.26.56.52.4L12.04 18c.32.03.64.04.96.04 4.97 0 9-3.34 9-7.5S16.97 3 12 3z"
        />
      </svg>
    ),
  ...
  return (
    ...
    >
      <Button
        ...
        disabled={loading}
        className={`
          w-full bg-[#111111] text-gray-200 border h-12 rounded-lg
      ...
      >
        <div className="flex items-center justify-center space-x-3">
          ...
          <span className="font-medium">
            {loading ? '연결 중...' : `${config.name}로 계속하기`}
          </span>
        </div>
